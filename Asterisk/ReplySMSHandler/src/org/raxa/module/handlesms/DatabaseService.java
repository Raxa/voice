 ...
 * @param inDate  Time when SMS is received
 * @param message  Query received
 ...
 * @param transID  transaction ID generated from the service provided by SMSGateway
 */
...
public static void saveIncomingSMS(String pnumber, String sysNumber, Date inDate, String message){
  ...
  /**
   * Get the patient with given phone number matching the specified followupquestion
   * Returns null in case the patient with given phone number is not part of the specified followup qstn
   * @param pnumber : phone number
   * @param fid : followupqstn id
   * @return Patient
   */
  ...
  /**
   * returns all followup choices for a given followup question
   * @param fid
   * @return
   */
...
/**
 * persists a followup response to database
 * @param followupResponse
 * @return
 */
