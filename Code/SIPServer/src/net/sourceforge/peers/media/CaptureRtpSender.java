...
public class CaptureRtpSender {
    ...
    public static final int PIPE_SIZE = 40960;
    ...
    public CaptureRtpSender(RtpSession rtpSession, SoundManager soundManager,
            ...
            Receiver server, WavReader wavReader)
            throws IOException {
        super();
        ...
        capture = new Capture(rawDataOutput, soundManager, logger, latch, server, wavReader);
